...
if (miss) stop ("unmatched node provided");
 ...
 //CharacterVector rval(index.size(),"");  // len celkovy pocet bez konkretnych vysledkov
List rval(index.size());
...
//downstreamCpp(as(object,"matrix"), nodes(object), de)