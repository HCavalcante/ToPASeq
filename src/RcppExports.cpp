...
RcppExport SEXP ToPASeq2_accCpp(SEXP AMSEXP, SEXP nodeNamesSEXP, SEXP indexSEXP) {
BEGIN_RCPP
    SEXP __sexp_result;
        {
        ...
        List __result = accCpp(AM, nodeNames, index);
...
RcppExport SEXP cpp_downstreamCpp(SEXP AMSEXP, SEXP nodeNamesSEXP, SEXP indexSEXP) {
BEGIN_RCPP
...
RcppExport SEXP xx_colMax(SEXP XSEXP) {
BEGIN_RCPP
    Rcpp::RObject __result;
    Rcpp::RNGScope __rngScope;
...
RcppExport SEXP xx_colMin(SEXP XSEXP) {
BEGIN_RCPP
    Rcpp::RObject __result;
    Rcpp::RNGScope __rngScope;
    Rcpp::traits::input_parameter< NumericMatrix >::type X(XSEXP);
